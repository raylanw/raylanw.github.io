...
<template>
  <header
    ref="navbar"
    class="z-40 w-full h-20 bg-op-90 dark:bg-op-90 backdrop-blur-3 backdrop-saturate-50 select-none"
    :class="[
      isLeave
  ...
  >
    <div class="max-w-120ch m-auto flex justify-between items-center">
      ...
      >
        ...
        <img class="b-rd-10" width="44" height="44" src="/avatar.jpg" alt="logo">
      </router-link>
