...
export const _VARS: Theme = {
  ...
  fontFamily: {
    sans: '"LXGW WenKai Screen R","Inter var experimental","Inter var","Inter","Noto Sans SC",system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji',
